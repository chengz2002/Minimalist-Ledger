...
export const TransactionList: React.FC<TransactionListProps> = ({
  ...
  // Register back button handler for transaction action modal
  useEffect(() => {
    if (!selectedTx) return;
    backButtonManager.register('transaction-action-modal', () => {
      setSelectedTx(null);
      return true;
    }, 100);

    return () => {
      backButtonManager.unregister('transaction-action-modal');
    };
  }, [selectedTx]);
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="flex flex-col min-w-0">
                      <div className="flex items-center gap-1.5">
                        ...
                        {tx.isAmortized && (
                          <span className="text-[10px] px-1.5 py-0.2 rounded-full bg-purple-50 dark:bg-purple-950/40 text-purple-600 dark:text-purple-400 font-medium shrink-0">
                            当月均摊
                          </span>
                        )}
                      </div>
            ...
            <div className="flex items-center gap-3 border-b border-gray-100 dark:border-gray-800 pb-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-400 flex items-center gap-1.5 flex-wrap mt-0.5">
                  ...
                  {selectedTx.accountName ? <span>· {selectedTx.accountName}</span> : null}
                  {selectedTx.isAmortized && (
                    <span className="text-[10px] px-1.5 py-0.2 rounded-full bg-purple-100 dark:bg-purple-900/50 text-purple-600 dark:text-purple-300 font-medium">
                      当月每日均摊
                    </span>
                  )}
                </div>
